...
class TestExecutionHandler(unittest.TestCase):
    ...
    def test_handle_signal_success(self):
        ...
        # Mock signal data (similar to what would be generated by SimpleArbitrageStrategy)
        signal_data = {
        ...
        self.mock_order_manager.create_order.assert_called_once_with(
            ...
            quantity=0.01,
            price=None,  # No price for market orders
            params={"arbitrage_leg": 1, "arbitrage_path": "USDT->BTC->ETH->USDT"},
        )
        
        # Verify risk manager's update_position was called with correct parameters
        self.mock_risk_manager.update_position.assert_called_once_with(
            symbol="BTC/USDT",
            quantity=0.01,
            side="buy"
        )
    ...
    def test_handle_signal_with_order_creation_failure(self):
        ...
        # Verify risk manager's update_position was not called
        self.mock_risk_manager.update_position.assert_not_called()
